...
void HackMakeCurrent() ;
 ...
 TiltFiveService* TiltFiveService::instance = nullptr;
...
bool TiltFiveService::Initialize() 
{
...
void TiltFiveService::Uninitialize() 
{
    for(GlassesPtr glasses : mGlassesList) 
    {
        glasses->Release();
...
bool TiltFiveService::GetServiceVersion()
{
...
bool TiltFiveService::GetGlassesList()
{
...
bool TiltFiveService::IsInitialized()
{
    return isInitialized;
}

void TiltFiveService::Process()
{
    if(!activeGlasses)
        return;
